...
@section('content')
    <style>
        ...
        .card-transaction {
            background: linear-gradient(120deg, #00bcd4 60%, #1976d2 100%);
        }

        .card-income {
            background: linear-gradient(120deg, #43a047 60%, #ffc107 100%);
        }
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="dashboard-card card-user">
                ...
                <div class="card-desc">
                    <a style="text-decoration: none;" href="{{ route('admin.category.index') }}" class="card-desc">
                        Tampilkan Data <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="dashboard-card card-transaction">
                ...
                <div class="card-desc">
                    <a style="text-decoration: none;" href="{{ route('admin.warehouse.index') }}" class="card-desc">
                        Tampilkan Data <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="dashboard-card card-income">
                ...
                <div class="card-desc">
                    <a style="text-decoration: none;" href="{{ route('admin.items.index') }}" class="card-desc"> Tampilkan
                        Data <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4" style="border-radius:16px;">
        ...
        <div class="card-body p-3">
            <div class="table-responsive">
                <table class="table table-striped mb-0" id="tableEmptyItems">
                    <thead>
                        <tr>
                            <th>Item</th>
                            <th>Lokasi</th>
    ...
    <div class="mb-3">
        ...
        <select id="itemSelect" class="form-select select2" style="max-width:300px;">
    ...
    @push('scripts')
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                // Initialize DataTable for Empty Items
                $('#tableEmptyItems').DataTable({
                    "paging": true,
                    "lengthChange": true,
                    "searching": true,
                    "ordering": true,
                ...
                const initialItemId = $('#itemSelect').val();
                if (initialItemId) {
                    renderChart(initialItemId);
                }
            });
