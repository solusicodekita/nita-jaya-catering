...
<body>
    ...
    <div class="container">
        ...
        <!-- Footer -->
        <table style="width: 100%; font-size: 8.5px; margin-top: 4px; font-weight: bold; border-collapse: collapse;">
            <tr>
                ...
                <td style="vertical-align: bottom; text-align: right; width: 25%; font-size: 10px; font-weight: bold;">
                    PAK JALAL
                </td>
            </tr>
        </table>
