...
Route::get('/', [App\Http\Controllers\Portal\LandingPageController::class, 'index'])->name('landing');
Route::get('/katalog/{slug}', [App\Http\Controllers\Portal\LandingPageController::class, 'show'])->name('katalog.show');
Route::get('/event/{slug}', [App\Http\Controllers\Portal\LandingPageController::class, 'event_show'])->name('event.show');
...
Route::middleware(['xss'])->group(function () {
    ...
    Route::middleware(['auth'])->prefix('pos')->name('admin.')->group(function () {
        Route::get('/dashboard', [App\Http\Controllers\HomeController::class, 'pos_dashboard'])->name('dashboard');
    ...
    // --- PORTAL ADMIN (COMPANY PROFILE & MARKETING) ---
    Route::middleware(['auth', 'role_check:superadmin'])->prefix('portal')->name('portal.')->group(function() {
        Route::get('/dashboard', [\App\Http\Controllers\Portal\PortalDashboardController::class, 'index'])->name('dashboard');
        Route::resource('menus', \App\Http\Controllers\Portal\PortalMenuController::class);
        Route::resource('events', \App\Http\Controllers\Portal\PortalEventController::class);
        Route::resource('services', \App\Http\Controllers\Portal\PortalServiceController::class);
        Route::get('/settings', [\App\Http\Controllers\Portal\SettingController::class, 'edit'])->name('settings.edit');
        Route::get('/settings/hero', [\App\Http\Controllers\Portal\SettingController::class, 'hero'])->name('settings.hero');
        Route::post('/settings', [\App\Http\Controllers\Portal\SettingController::class, 'update'])->name('settings.update');
    });
